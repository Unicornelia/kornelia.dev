...
export const jobTabs = [
  {
    ...
    company: "CoachHub",
    content:
      "In this role, I contributed to the development of scalable web applications using React, Nest.js, GraphQL, TypeScript and TDD to mention a few. I collaborated with cross-functional teams to design, implement, and maintain features that directly impacted user engagement and platform growth. As a fullstack developer I was responsible for building and maintaining both the user-facing and backend components of the application. Ensured code quality and reliability using Jest and Cypress while optimizing performance with Webpack and Babel. Managed deployments with Heroku, Docker, and Kubernetes, and maintained a robust database structure with PostgreSQL. Collaborated in an Agile/Scrum environment, leveraging Git for version control and adhering to best practices in HTML5 and CSS3.",
  },
  {
